Made a web application using node.js. The app displays some basic information about myself using HTML but node is used to start the server required to run it on the web.
